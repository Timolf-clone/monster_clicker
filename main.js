...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu!='')
			{
				str += '<div style="position:absolute;top:8px;right:8px;cursor:pointer;font-size:22px;font-family:\'Momo Trust Display\', cursive;color:#ffccaa;text-shadow:1px 1px 3px #000;" onclick="Game.ShowMenu(Game.onMenu);">✖</div>';
